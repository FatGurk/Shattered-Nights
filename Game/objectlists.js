...
export const CharacterList = [
    ...
    new Npc(42 * TILE_SIZE, 18 * TILE_SIZE, "Mad scientist GW", "./game/pictures/characters/gw.png", "GW \nWho sent you here and do you have anything for me?", "Ohh are those flowers for me? \nThank you! \nHere, take this as a thank you for saving me." , questList[2], null, (player) => player.countBlomma >= 3),
    new Npc (9 * TILE_SIZE, 0.5 * TILE_SIZE, "Sten Med Spade","./game/pictures/characters/stenspade.png", "Sten \nI was going to get some flowers for my friend Gw, \nbut then the moon exploded and all flowers died. \nI hate this stupid sun, ugh here take this stupid shovel, \nI dont have a need for it anylonger.", null , questList[2], "Shovel"),
    new Npc(37 * TILE_SIZE, 29.5 * TILE_SIZE, "Stefan", "./game/pictures/characters/stefan.png", "Stefan \nHello, you want to play a game?", "Imposible!!! You are the only one who have beaten me. Well this is yours now." , null, null, null),
    new Npc(14 * TILE_SIZE, 28.5 * TILE_SIZE, "Anton", "./game/pictures/characters/anton.png", "Anton \nHello, my rabbit have eaten the key to my house. \nI need to give him a carrot so he can shit the key out. \nCan you grow some carrots for me? I lost my shovel.", "Thank you for giving me the carrot, \nhere take this as a thanks for the trubble.", questList[1], null, "Carrot"),
]